...
| Integração | Cascata por família: cada granularidade vs soma do diário no intervalo, validando que a soma bate, para cada uma das quatro famílias |
...
| TC04 | Soma semanal bate com soma dos diários, por família | Inserir N dias (5–7) de fato diário no intervalo da semana; rodar cascata semanal | Linha semanal = soma exata dos diários presentes no intervalo, mesmas dimensões, mesma família |
